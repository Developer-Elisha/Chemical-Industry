  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 sm:text-3xl">Purchase</h1>
          <p className="mt-1 text-gray-500">Manage your chemical Purchase inventory</p>
        </div>
          ...
          <button
            onClick={() => {
              ...
              setFormData({ 
                ...
                previousBalance: 0,
                netBalance: 0,
                netTotal: 0, // Initialize netTotal
              });
              setIsFormOpen(true);
            }}
      ...
      <PurchaseDelete
        ...
        product={deletingProduct} // This should be of type Purchase | null
      />
    </div>
  );
}