...
import { Purchase } from '../../types'; // Import the Purchase type

interface PurchaseDeleteProps {
  isOpen: boolean;
  onClose: () => void;
  onConfirm: () => void;
  product: Purchase | null; // Change from Product to Purchase
}

export function PurchaseDelete({ isOpen, onClose, onConfirm, product }: PurchaseDeleteProps) {
