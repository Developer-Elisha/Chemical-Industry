...
export function ProductDelete({ isOpen, onClose, onConfirm, product }: ProductDeleteProps) {
            ...
            <div className="flex flex-col items-center justify-center h-full space-y-6">
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-gray-500">
                  <span className="font-medium">{product.name}</span> will be permanently removed.
